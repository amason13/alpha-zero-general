...
from othello.keras.CNN import NNetWrapper as NNet
from othello.keras.NN128 import NNetWrapper as NNet2
from othello.keras.LSTM128 import NNetWrapper as NNet3
...
'''
print('rand vs greedy')
arena = Arena.Arena(rp, gp, g, display=display)
